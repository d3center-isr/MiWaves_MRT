...
df_temp$avg_trt <- mean(df_temp$actioni)  
fit2 <- wcls(
    data = df_temp,
    id = "id",
    outcome = "prop_awakeuse_c",
...
df_engag$avg_trt <- mean(df_engag$actioni) 
fit_wocov_b <- wcls(
    data = df_engag,
    id = "id",
    outcome = "engagement_multi_c",
...
df_engag_temp$avg_trt <- mean(df_engag_temp$actioni) 
fit2 <- wcls(
    data = df_engag_temp,
    id = "id",
    outcome = "engagement_multi_c",
