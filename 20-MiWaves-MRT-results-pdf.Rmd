...
r[[23]] <- summary(fit13)$causal_excursion_effect %>% as_tibble(rownames = "term") %>%
...
r[[25]] <- summary(fit14c)$causal_excursion_effect %>% as_tibble(rownames = "term") %>%
...
r[[26]] <- summary(fit14d)$causal_excursion_effect %>% as_tibble(rownames = "term") %>%
