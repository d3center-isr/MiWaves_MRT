...
fit_wcov <- wcls(
    ...
    rand_prob = "probi",
    moderator_formula = ~1,
    control_formula = ~ cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c  + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit3 <- wcls(
    ...
    control_formula = ~prop_awakeuse_prior_c + cov_interv_engag_72hrs_c  + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit4 <- wcls(
    ...
    control_formula = ~wks_since_interv_start + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c  + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit4b <- wcls(
    ...
    control_formula = ~after_day15 + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c  + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit7 <- wcls(
    ...
    control_formula = ~prior_sent_message + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit7b <- wcls(
    ...
    control_formula = ~prior_sent_messages_48hrs_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit9 <- wcls(
    ...
    control_formula = ~male_sex + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit10 <- wcls(
    ...
    control_formula = ~white_race + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit11 <- wcls(
    ...
    control_formula = ~hispanic_ethn + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit12 <- wcls(
    ...
    control_formula = ~ canndays_bl_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit12b <- wcls(
    ...
    control_formula = ~dsmsc_tot_bl_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit13b <- wcls(
    ...
    control_formula = ~high_cann_importance_bl + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit13c <- wcls(
    ...
    control_formula = ~cann_likely_bl_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit13d <- wcls(
    ...
    control_formula = ~cann_conf_bl_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit14 <- wcls(
    ...
    control_formula = ~phq2_tot_bl_c + cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl_c + cannhours_bl_c + cannwake_bl_c
)
...
fit13_can_unc <- wcls(
    ...
    control_formula = ~cov_prop_awakeuse_48hrs_c + cov_interv_engag_72hrs_c + timeofday + week_day_binary + cann_importance_bl + cannhours_bl_c + cannwake_bl_c
)
...
m2 <- df %>% 
  ...
  geom_text(aes(x=2.565786+0.95, 
                label=stringr::str_wrap("\nDiff at -1 SD: 0.021 (95% CI: 0.007, 0.034; p=0.001)",25),
                y=0.12), 
            colour="black", size=7/.pt) +
  geom_text(aes(x=4.8461+1, 
                label=stringr::str_wrap("\nDiff at mean: 0.009 (95% CI: -0.001, 0.019; p=0.099)",25),
                y=0.12), 
            colour="black", size=7/.pt) +
  geom_text(aes(x=7.126414+1, 
                label=stringr::str_wrap("\nDiff at +1 SD: -0.003 (95% CI: -0.017, 0.011; p=0.846)",25),
                y=0.12), 
            colour="black", size=7/.pt) +
