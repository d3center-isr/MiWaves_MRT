...
reg_results %>%
    kable(
    align = "c", caption = "Univariate associations of variable with proximal proportion of waking hours using cannabis, adjusting for time of day and using linear mixed effects regression with a random intercept")%>%
  kable_classic(full_width = F)
